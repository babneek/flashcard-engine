        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="space-y-6">
              {[
                { icon: Sparkles, text: 'AI-powered card generation from any PDF' },
                { icon: BookOpen, text: 'SM-2 spaced repetition algorithm' },
                { icon: Zap, text: 'Track mastery and optimize your learning' },
              ].map((item, i) => (
                <motion.div
                  key={i}
